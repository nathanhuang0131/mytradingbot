...
| --- | --- | --- | --- | --- | ---: | ---: |
| DYN | alpaca_paper_api | qlib_candidate_only | rejected | invalid_signal_payload | 0.0114 | 0.0114 |
...
| CRGY | alpaca_paper_api | qlib_candidate_only | rejected | liquidity_too_low | 0.0018 | 0.0018 |
| FIGR | alpaca_paper_api | qlib_candidate_only | rejected | liquidity_too_low | -0.0016 | -0.0016 |
| ZM | alpaca_paper_api | qlib_candidate_only | rejected | invalid_signal_payload | -0.0015 | -0.0015 |
| NESR | alpaca_paper_api | qlib_candidate_only | rejected | spread_too_wide | 0.0015 | 0.0015 |
| ADMA | alpaca_paper_api | qlib_candidate_only | rejected | spread_too_wide | 0.0012 | 0.0012 |
| FIVN | alpaca_paper_api | qlib_candidate_only | rejected | invalid_signal_payload | 0.0012 | 0.0012 |
